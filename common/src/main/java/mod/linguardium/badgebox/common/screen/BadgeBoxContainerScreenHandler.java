...
public class BadgeBoxContainerScreenHandler extends ScreenHandler {
    ...
    public BadgeBoxContainerScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, boolean hasRibbonSlotStack, int boxSlot) {
    ...
    public static BadgeBoxContainerScreenHandler create(int syncId, PlayerInventory playerInventory, PacketByteBuf buf) {
        ExtendedScreenHandlerData data = ExtendedScreenHandlerData.PACKET_CODEC.decode(buf);
    ...
    public BadgeBoxContainerScreenHandler(int syncId, PlayerInventory playerInventory, ExtendedScreenHandlerData data) {
        this(syncId, playerInventory, createClientsideInventory(data), data.ribbon, data.boxSlot());
    }
